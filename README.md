...
python main.py --sparse --method GraNet --death-rate 0.5 --optimizer sgd --sparse-init ERK --init-density 1 --final-density 0.10 --update_frequency 1000  --l2 0.0005  --lr 0.1 --epochs 160 --model ResNet50 --data cifar10  

### GraNet (s_i = 0.5) start from a 50% sparse network

python main.py --sparse --method GraNet --death-rate 0.5 --optimizer sgd --sparse-init ERK --init-density 0.50 --final-density 0.10 --update_frequency 1000  --l2 0.0005  --lr 0.1 --epochs 160 --model ResNet50 --data cifar10  

### RigL (ITOP Version)

python main.py --sparse --method DST --death-rate 0.5 --optimizer sgd --sparse-init ERK --init-density 0.10 --final-density 0.10 --update_frequency 1000  --l2 0.0005  --lr 0.1 --epochs 160 --model ResNet50 --data cifar10  


### GMP 

python main.py --sparse --method GMP --death-rate 0.5 --optimizer sgd --sparse-init ERK --init-density 1 --final-density 0.10 --update_frequency 1000  --l2 0.0005  --lr 0.1 --epochs 160 --model ResNet50 --data cifar10  
